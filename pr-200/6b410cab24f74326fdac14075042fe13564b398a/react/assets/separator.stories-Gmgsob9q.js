import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{M as n,r}from"./utils-C5n3ayfX.js";import{n as i,t as a}from"./separator-llRe5VG3.js";var o,s,c,l,u,d;e((()=>{r(),i(),o=t(),s={title:`Components/Separator`,component:a,parameters:{docs:{description:{component:n.docs.description}},design:{type:`figma`,url:`https://www.figma.com/design/pEp49benCBB2MYxWvs5A6t/Curve-Design-System?node-id=118-2682`}},argTypes:{orientation:{control:`inline-radio`,options:n.props.orientations,description:n.props.orientations.map(e=>`\`${e}\` — ${n.docs.orientations[e]}`).join(`
