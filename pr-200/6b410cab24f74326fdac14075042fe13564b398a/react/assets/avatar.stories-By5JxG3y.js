import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{ln as n,r}from"./utils-C5n3ayfX.js";import{a as i,i as a,n as o,o as s,r as c,t as l}from"./avatar-B6zChqJo.js";var u,d,f,p,m,h,g;e((()=>{r(),s(),u=t(),d={title:`Components/Avatar`,component:l,parameters:{docs:{description:{component:n.docs.description}},design:{type:`figma`,url:`https://www.figma.com/design/pEp49benCBB2MYxWvs5A6t/Curve-Design-System?node-id=296-5188&t=vT3gKkMDSpQaeqci-4`}},argTypes:{size:{control:`inline-radio`,options:n.props.sizes,description:n.props.sizes.map(e=>`\`${e}\` — ${n.docs.sizes[e]}`).join(`
