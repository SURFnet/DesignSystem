...
declare function NavigationMenu({ align, className, children, orientation, ...props }: NavigationMenuPrimitive.Root.Props & Pick<NavigationMenuPrimitive.Positioner.Props, 'align'>): import("react").JSX.Element;
...
declare function navigationMenuTriggerStyle(): string | undefined;
