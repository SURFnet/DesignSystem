...
import { SidebarInset, SidebarProvider, SidebarTrigger } from '@surfnet/curve-react';

import { AppSidebar } from '@/components/app-sidebar';
import type { SessionUser } from '@/lib/mock-data';

/**
 * Client shell for the app area. Holds everything that pulls in `@surfnet/curve-react`
