...
| `border-input`           | `border-input` _(class gelijk; var `--input` → `--border-input`)_ |
...
| `--foreground-item-selected`   | Tekst op selected _(optioneel)_         | [Hover states](./hover-states.md)                   |
...
| `--border-card`                | Card border _(alleen indien ≠ default)_ | Open                                                |
...
| `--background-secondary`  | Secondary button        | `neutral-100` _(mag = subtle)_ | `neutral-800` |
| `--background-item-hover` | Interactieve hover      | `neutral-200` _(≠ subtle)_     | `neutral-700` |
